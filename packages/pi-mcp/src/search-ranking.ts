...
import { getServerPrefix, getToolNameCandidates, isServerDisabled, matchesToolPattern, resolveToolPrefix } from "./tool-naming.js";
import { isServerInActiveFailureBackoff, type SearchState } from "./failure-backoff.js";

export type { SearchState } from "./failure-backoff.js";
...
const searchCache = new WeakMap<SearchState, Map<string, CachedServerSearch>>();
...
export function rankSuggestions(state: SearchState, name: string, limit: number): string[] {
