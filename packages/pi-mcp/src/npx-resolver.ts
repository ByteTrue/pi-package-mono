...
// Ported verbatim from pi-mcp-adapter (MIT). Cache file (mcp-npx-cache.json,
// v2 format) is shared-compatible with upstream, so an existing warm cache
// carries over on migration.
