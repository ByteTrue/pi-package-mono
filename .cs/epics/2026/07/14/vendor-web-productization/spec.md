...
Add model 三源主路径与 discover 已实现；下一步可收动作文案或 owner 关闭 epic。
...
- [ ] `.cs/issues/2026/07/14/open-web-add-model-main-path.md`：Add model 主路径对齐 TUI（含 discover）— 实现完成，待 owner 确认关闭
