...
视觉骨架与全字段编辑器已完成；下一步是 Add model 三源主路径（catalog / custom / import）并接线 discover。
...
- [ ] `.cs/issues/2026/07/14/open-web-add-model-main-path.md`：Add model 主路径对齐 TUI（含 discover）
...
- 无；Add model 设计时明确 catalog/custom/import 入口与 discover 失败态。
