...
1. **能力优先**：先把「按 id 官方填充」接进模型编辑器，再对齐 Add model 三源路径与表单字段。
...
首批目标、依赖与验证已足够清楚，可开 issue。

### Issues

- [ ] `.cs/issues/2026/07/14/open-web-model-editor-official-fill.md`：编辑器 id→官方填充
...
- 无阻塞；实现 issue 1 前可再确认歧义 UI 文案细节
