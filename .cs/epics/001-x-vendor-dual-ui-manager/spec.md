...
- [x] `.cs/issues/012-x-vendor-config-core.md`
- [x] `.cs/issues/016-x-vendor-web-modal-runtime.md`
- [x] `.cs/issues/014-x-vendor-model-source-core.md`
- [x] `.cs/issues/015-x-vendor-tui-quick-workflows.md`
- [x] `.cs/issues/018-x-vendor-web-provider-workflows.md`
- [x] `.cs/issues/017-x-vendor-web-model-workflows.md`
- [x] `.cs/issues/013-x-vendor-dual-ui-hardening.md`
...
- 讨论：`.cs/talks/001-vendor-dual-ui-manager.md`
