...
- 隶属 epic：`.cs/epics/003-x-vendor-ai-first/spec.md`（切片 4）
...
- closed issues：`.cs/issues/016-x-vendor-web-modal-runtime.md`、`.cs/issues/017-x-vendor-web-model-workflows.md`、`.cs/issues/018-x-vendor-web-provider-workflows.md`、`.cs/issues/019-x-web-actions-copy.md` 至 `.cs/issues/024-x-web-visual-redesign.md`
