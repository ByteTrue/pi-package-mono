...
- epic：`.cs/epics/002-x-vendor-web-productization/spec.md`（视觉骨架完成、全站无滚动条、editor 双栏与全字段）
...
- **回写位置**：epic 当前推进。
- **遗留事项**：`/api/discover` 与 Add model 三源主路径 → `.cs/issues/020-x-web-add-model-main-path.md`；动作文案精修 → `.cs/issues/019-x-web-actions-copy.md`。
