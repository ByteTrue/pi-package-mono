...
- `.cs/notes/005-pi-local-package-loading.md` — 记录 setup 时序与本地 package 单来源边界。
- `.cs/spec/index.md` — 记录 worktree 的开发环境准备方式。
...
- 已同步 project spec：`.cs/spec/index.md`。
- 已同步 note：`.cs/notes/005-pi-local-package-loading.md`。
