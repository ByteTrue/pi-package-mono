...
status: closed
created: 2026-07-12
epic: ".cs/epics/001-x-vendor-dual-ui-manager/spec.md"
superseded_by: ".cs/epics/003-x-vendor-ai-first/spec.md"
---
...
- 隶属 epic：`.cs/epics/001-x-vendor-dual-ui-manager/spec.md`
- 相关 spec：`.cs/spec/pi-vendor/index.md`

## 背景与证据

- 旧 feature 目录：`.cs/archive/codestable-legacy/features/2026-07-12-vendor-web-provider-workflows/`
...
- 旧 QA/acceptance 文档：`.cs/archive/codestable-legacy/features/2026-07-12-vendor-web-provider-workflows/`
...
- epic：`.cs/epics/001-x-vendor-dual-ui-manager/spec.md`（issue 列表与完成事实）
