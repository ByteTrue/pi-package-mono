...
- 讨论：`.cs/talks/004-background-terminal-redesign.md`
- 历史：`.cs/issues/025-x-background-terminal-package.md`、`.cs/issues/037-x-background-terminal-tool-selection.md`、`.cs/issues/038-x-background-terminal-bash-override-redesign.md`
- 独立工具版本：`.cs/issues/039-x-background-terminal-standalone-tools.md`
- 生命周期与菜单：`.cs/issues/042-x-background-terminal-menu-lifecycle.md`
