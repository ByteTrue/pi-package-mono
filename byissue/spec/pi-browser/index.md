...
- 本轮替换：`byissue/epics/005-o-browser-direct-profile-target/issues/003-x-agent-browser-core-replacement.md`
- 旧模型历史与反证：`byissue/epics/005-o-browser-direct-profile-target/issues/001-x-m0-real-profile-pierce.md`、`002-x-target-decouple-and-gates.md`
