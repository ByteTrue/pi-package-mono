...
status: closed
created: 2026-07-12
superseded_by: "byissue/epics/003-x-vendor-ai-first/spec.md"
---
...
- `byissue/spec/pi-vendor/index.md`：本 epic 的稳定能力与边界已毕业到此
- `byissue/spec/index.md`：monorepo 能力地图中的 vendor 条目
...
- [x] `byissue/issues/012-x-vendor-config-core.md`
- [x] `byissue/issues/016-x-vendor-web-modal-runtime.md`
- [x] `byissue/issues/014-x-vendor-model-source-core.md`
- [x] `byissue/issues/015-x-vendor-tui-quick-workflows.md`
- [x] `byissue/issues/018-x-vendor-web-provider-workflows.md`
- [x] `byissue/issues/017-x-vendor-web-model-workflows.md`
- [x] `byissue/issues/013-x-vendor-dual-ui-hardening.md`
...
- 已合并：双 UI 能力、三子系统、密钥与 revision 语义、边界与不做项 → `byissue/spec/pi-vendor/index.md` 与根能力地图

## 关闭回写

- 状态：`closed`
- 合并位置：`byissue/spec/pi-vendor/index.md`、`byissue/spec/index.md`
- Vision：本 Epic 没有来源 Vision，因此无 Vision 状态需更新
- 保留材料：旧 design/review/qa/goal-protocol 全量在 `byissue/archive/codestable-legacy/roadmap|features/`

## 相关材料（按需）

- 讨论：`byissue/talks/001-vendor-dual-ui-manager.md`
- 旧 roadmap 正文：`byissue/archive/codestable-legacy/roadmap/vendor-dual-ui-manager/vendor-dual-ui-manager-roadmap.md`
