...
- **制度代价真实**：作废一个已关闭的 epic（`vendor-web-productization`）、project spec 一大块、约 10 个已关 issue。代码代价小。历史留在 `byissue/archive/`。
...
Epic：`byissue/epics/003-x-vendor-ai-first/spec.md`，四个切片 issue。owner 确认后直接开切片 1。
