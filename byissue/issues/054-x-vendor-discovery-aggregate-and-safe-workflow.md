...
- `byissue/issues/034-x-vendor-protocol-discovery.md`：已关闭的协议级异构 discovery 支持。
- `byissue/issues/035-x-vendor-skill-script.md`：已关闭的 Skill bundled script 架构切换。
- `byissue/spec/pi-vendor/index.md`：当前 pi-vendor 稳定规格。
