...
- `README.md`
- `package-lock.json`
- `byissue/spec/index.md`
- `byissue/spec/pi-ask-user/index.md`
...
- 稳定约束已回写 `byissue/spec/pi-ask-user/index.md` 与 project spec；未来若 OpenCode schema 或 Pi `ctx.ui.custom` 契约变化，应以这两个上游接口为回归锚点。
