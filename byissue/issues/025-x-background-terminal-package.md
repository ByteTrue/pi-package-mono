...
- 相关真相：`byissue/spec/index.md`、`byissue/spec/pi-background-terminal/index.md`
...
- project spec：`byissue/spec/index.md`（新增第四个包、能力地图、边界、阅读路径）
- package spec：`byissue/spec/pi-background-terminal/index.md`
- note：`byissue/notes/005-pi-local-package-loading.md`
