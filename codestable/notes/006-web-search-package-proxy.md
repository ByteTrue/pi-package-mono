...
- closed：`codestable/issues/010-x-web-proxy-global-side-effect.md`
- spec：`codestable/spec/pi-web-search/index.md`
- 旧 refactor scan：`codestable/archive/codestable-legacy/refactors/2026-07-11-web-proxy-ownership/`
