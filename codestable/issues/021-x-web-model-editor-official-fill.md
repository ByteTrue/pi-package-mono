...
status: closed
created: 2026-07-14
epic: "codestable/epics/002-x-vendor-web-productization/spec.md"
...
- 隶属 epic：`codestable/epics/002-x-vendor-web-productization/spec.md`
- 相关 spec：`codestable/spec/pi-vendor/index.md`

## 背景与证据

- talk：`codestable/talks/002-vendor-web-productization.md`
...
- epic：`codestable/epics/002-x-vendor-web-productization/spec.md`（issue 1 完成事实、active Pi catalog 约束、下一步）
- note：`codestable/notes/001-active-pi-catalog.md`（运行时 / `dev:web` catalog 选择规则）
...
- **遗留事项**：Add model 三源主路径（含 discover 接线）继续由 `codestable/issues/020-x-web-add-model-main-path.md` 承担。
