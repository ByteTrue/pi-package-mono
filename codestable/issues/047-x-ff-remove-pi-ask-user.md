...
- 保留 `codestable/issues/043-x-ff-ask-user-question.md` 作为当时实现的历史证据；未提交的 RPC follow-up 随已取消能力一起删除。
...
- 删除 `codestable/spec/pi-ask-user/`
- 删除未提交的 `codestable/issues/044-o-ff-ask-user-rpc-ui.md`
- 更新 `README.md`
- 更新 `codestable/spec/index.md`
