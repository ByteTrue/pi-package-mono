...
- 相关真相：`codestable/spec/index.md`、`codestable/spec/pi-background-terminal/index.md`
...
- project spec：`codestable/spec/index.md`（新增第四个包、能力地图、边界、阅读路径）
- package spec：`codestable/spec/pi-background-terminal/index.md`
- note：`codestable/notes/005-pi-local-package-loading.md`
