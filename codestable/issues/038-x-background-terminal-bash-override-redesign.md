...
created: 2026-08-01
epic: ""
superseded_by: "codestable/issues/039-x-background-terminal-standalone-tools.md"
---
...
- 独立 issue，取代 `codestable/issues/037-x-background-terminal-tool-selection.md`。
...
- **必须修改**：整包重写。删除 `src/pty/`、`src/web/`、5 个 `tools/pty-*.ts`、`commands.ts`、`browser.ts`、`register-tools.ts`；`package.json` 去掉 `@lydell/node-pty`/`ws`/`@xterm/*`/`esbuild`；README、`codestable/spec/pi-background-terminal/index.md`、根 `README.md`。
