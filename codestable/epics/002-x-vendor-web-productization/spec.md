...
- `codestable/spec/pi-vendor/index.md`：Web 能力与边界；本 epic 将扩展「Web 日常可用」的完成度描述
- `codestable/spec/index.md`：当前方向
- 讨论：`codestable/talks/002-vendor-web-productization.md`
- 前序（已关闭）：`codestable/epics/001-x-vendor-dual-ui-manager/spec.md`
...
该 Epic 已关闭；稳定结论已毕业到 `codestable/spec/pi-vendor/index.md` 的「Web 完整管理」与「Web 产品化已关闭」。

### Issues

- [x] `codestable/issues/021-x-web-model-editor-official-fill.md`：编辑器 id→官方填充（含 active-Pi catalog 回归修复）
- [x] `codestable/issues/024-x-web-visual-redesign.md`：全表面视觉重设计（owner 验收）
- [x] `codestable/issues/022-x-web-model-form-fields.md`：模型表单全字段（与视觉重设计一并验收）
- [x] `codestable/issues/020-x-web-add-model-main-path.md`：Add model 主路径 + discover + import dialog（owner 验收）
- [x] `codestable/issues/019-x-web-actions-copy.md`：动作栏与文案（owner 验收）
- [~] `codestable/issues/023-x-web-layout-density.md`：被视觉重设计取代
...
- 稳定结论合并回 `codestable/spec/pi-vendor/index.md`
...
- 状态：`closed`
- 合并位置：`codestable/spec/pi-vendor/index.md`（Web 完整管理、主路径与架构考量）；`codestable/spec/index.md`（当前方向、阅读路径）
