...
- 浏览器能力：`packages/pi-browser`、`codestable/spec/pi-browser/index.md`、`codestable/epics/005-o-browser-direct-profile-target/`（真实 Profile 反证、agent-browser 替换决策与穿刺证据）
