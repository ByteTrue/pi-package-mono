...
| [`@bytetrue/pi-vendor`](packages/pi-vendor) | AI-first `models.json` management: bundled Skill + read-only catalog/discovery/validation tools, with `/vendor` as a minimal cold-start wizard. |
